...
export class ExtrabedSelectorComponent {
    ...
    setExtrabeds() {
        this.extrabeds = [
            { label: this.translate.instant('EXTRABEDS.M'), value: 'M', color: 'yellow' },   // matrac fér be
            { label: this.translate.instant('EXTRABEDS.MM'), value: 'MM', color: 'orange' }, // 2 db matrac fér
            { label: this.translate.instant('EXTRABEDS.MGY'), value: 'MGY', color: 'cyan' }, // matrac és gyerekágy fér be
            { label: this.translate.instant('EXTRABEDS.GY'), value: 'GY', color: 'pink' },   // gyerekágy fér be, A matrac helyett befér gyerekágy de fordítva nem
        ]
    }
