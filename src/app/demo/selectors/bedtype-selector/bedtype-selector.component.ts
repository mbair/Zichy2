...
export class BedtypeSelectorComponent implements OnInit, AfterViewChecked, ControlValueAccessor {
    ...
    private syncValueFromWidget(): void {
        ...
        if (widgetValue === undefined || widgetValue === null || widgetValue === this.selectedBedtype) {
            return
        }
    ...
    private applySelection(value: string, emitTouch = true, emitCva = true): void {
        ...
        if (this.selectedBedtype !== normalized) {
            this.selectedBedtype = normalized
        }
