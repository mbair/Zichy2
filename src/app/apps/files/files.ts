...
@Component({
    ...
    template: `
        <div class="flex flex-col gap-6 card">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center gap-1">
                                        ...
                                        <p-button icon="pi pi-ellipsis-h" [rounded]="true" [text]="true" size="small" severity="secondary" styleClass="cursor-pointer" (onClick)="tableMenu.toggle($event)" />
                                        <p-menu #tableMenu [model]="createTableMenuItems(doc)" [popup]="true" styleClass="w-48!" appendTo="body" />
                                    </div>
                                </td>
                            </tr>
                        </ng-template>
            ...
            <p-drawer [(visible)]="showEditDrawer" position="right" styleClass="w-full! max-w-[417px]!">
                <ng-template #header>
