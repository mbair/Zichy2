...
@Component({
    ...
    template: `
        <div id="pricing" class="my-12 py-12 md:my-20 md:py-20">
            ...
            <div class="flex flex-col lg:flex-row gap-4 gap-0 justify-center mt-20">
                <div class="w-full lg:w-1/2 xl:w-1/3">
                    <div class="p-4 h-full">
                        <div class="shadow p-12 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                            ...
                            <button pButton pRipple label="Choose Plan" class="px-8 w-full mt-12" outlined icon="pi pi-arrow-right" iconPos="right"></button>
                        </div>
                    </div>
                </div>
