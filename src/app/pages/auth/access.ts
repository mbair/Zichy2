...
@Component({
    ...
    template: ` <svg viewBox="0 0 960 540" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" class="min-h-screen min-w-screen fixed left-0" style="bottom:-10rem" preserveAspectRatio="none">
        ...
        <div class="px-8 min-h-screen flex justify-center items-center -mt-20 sm:mt-0">
            <div class="z-10 text-center">
                ...
                <p class="leading-normal mt-0 mb-8 text-surface-700 dark:text-surface-100 text-xl font-medium">You don't have the permissions to access this page</p>
                <p-button [routerLink]="[apolloRoutes.root]" severity="help" raised>Go to Dashboard</p-button>
            </div>
        </div>
