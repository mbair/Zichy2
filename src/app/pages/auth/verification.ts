...
@Component({
    ...
    imports: [ButtonModule, RouterModule, AppConfigurator, FormsModule, InputNumberModule, RippleModule],
    standalone: true,
            ...
            <div class="border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 rounded py-16 px-6 md:px-16 z-10">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-wrap gap-2 justify-between">
                        ...
                        <button pButton pRipple label="Verify" class="flex-auto" [routerLink]="[apolloRoutes.auth.newPassword]"></button>
                    </div>
                </div>
            </div>
        </div>
