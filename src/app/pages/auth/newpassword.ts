...
@Component({
    ...
    imports: [ButtonModule, RouterModule, AppConfigurator, IconFieldModule, InputIconModule, InputTextModule, PasswordModule],
    standalone: true,
            ...
            <div class="border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 rounded py-16 px-6 md:px-16 z-10">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-wrap gap-2 justify-between">
                        <button pButton pRipple label="Cancel" class="flex-auto" outlined [routerLink]="[apolloRoutes.auth.login]"></button>
                        <button pButton pRipple label="Submit" class="flex-auto" [routerLink]="[apolloRoutes.auth.login]"></button>
                    </div>
                </div>
            </div>
        </div>
