...
@Component({
    ...
    standalone: true,
    imports: [PasswordModule, FormsModule, InputTextModule, CheckboxModule, RouterModule, AppConfigurator, IconFieldModule, InputIconModule, ButtonModule, RippleModule],
    template: `
            ...
            <div class="border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 rounded py-16 px-6 md:px-16 z-10">
                ...
                <div class="flex flex-col">
                    <p-iconfield class="w-full mb-6">
                        ...
                        <input id="username" type="text" pInputText class="w-full md:w-[25rem]" placeholder="Username" />
                    </p-iconfield>
                    <p-iconfield class="w-full mb-6">
                    ...
                    <div class="mb-6 flex flex-wrap items-center">
                        <p-checkbox name="checkbox" value="val" [(ngModel)]="confirmed" styleClass="mr-2" class="flex" [binary]="true"></p-checkbox>
                    ...
                    <button pButton pRipple label="Sign Up" class="w-full mb-6" [routerLink]="[apolloRoutes.auth.verification]"></button>
                    <span class="font-medium text-surface-600 dark:text-surface-200"
                        >Already have an account? <a [routerLink]="[apolloRoutes.auth.login]" class="font-semibold cursor-pointer text-surface-900 dark:text-surface-0 hover:text-primary transition-colors duration-300">Login</a></span
                    >
                </div>
            </div>
        </div>
