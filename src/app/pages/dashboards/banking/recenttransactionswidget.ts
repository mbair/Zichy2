        ...
        <div class="card">
            ...
            <ul class="list-none p-0 m-0">
                <li class="flex items-center p-4 mb-4 border-b border-surface-200 dark:border-surface-700">
                    <img alt="brands" src="/demo/images/banking/airbnb.png" class="w-12 shrink-0 mr-4" />
                ...
                <li class="flex items-center p-4 mb-4 border-b border-surface-200 dark:border-surface-700">
                    <img alt="brands" src="/demo/images/banking/amazon.png" class="w-12 shrink-0 mr-4" />
                    <div class="flex flex-col">
                ...
                <li class="flex items-center p-4 mb-4 border-b border-surface-200 dark:border-surface-700">
                    <img alt="brands" src="/demo/images/banking/nike.svg" class="w-12 shrink-0 mr-4 rounded-full" />
                    <div class="flex flex-col">
                ...
                <li class="flex items-center p-4 mb-4 border-b border-surface-200 dark:border-surface-700">
                    <img alt="brands" src="/demo/images/banking/starbucks.svg" class="w-12 shrink-0 mr-4" />
                    <div class="flex flex-col">
