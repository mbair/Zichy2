...
import { FormStateService } from './create/form-state.service';
...
@Component({
    ...
    template: `
        <div class="flex flex-col bg-surface-0 dark:bg-surface-900 rounded-2xl border border-surface-200 dark:border-surface-700 overflow-hidden">
            ...
            <!-- Edit User Dialog -->
            <p-dialog [(visible)]="editDialogVisible" [modal]="true" header="Edit User" [style]="{ width: '30rem' }" >
...
export class UserList {
    ...
    addNewUser() {
        ...
        this.router.navigate([APOLLO_ROUTES.profile.createSteps.basicInformation]);
    }
