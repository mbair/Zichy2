...
export class BasicInformation {
    ...
    cancel() {
        ...
        this.router.navigate([APOLLO_ROUTES.profile.list]);
    }

    next() {
        this.router.navigate([APOLLO_ROUTES.profile.createSteps.businessInformation]);
    }

    private revokeProfilePhotoUrl() {
        const profilePhotoUrl = this.formState().profilePhotoUrl;
