    ...
    menuItems: MenuItem[] = [
        {
            ...
            shortLabel: 'Basic',
            icon: 'pi pi-user',
            route: APOLLO_ROUTES.profile.createSteps.basicInformation
        },
        {
            label: 'Business Information',
            shortLabel: 'Business',
            icon: 'pi pi-briefcase',
            route: APOLLO_ROUTES.profile.createSteps.businessInformation
        },
        {
            label: 'Location Information',
            shortLabel: 'Location',
            icon: 'pi pi-map-marker',
            route: APOLLO_ROUTES.profile.createSteps.locationInformation
        },
        {
            label: 'Authorization and Access',
            shortLabel: 'Access',
            icon: 'pi pi-key',
            route: APOLLO_ROUTES.profile.createSteps.authorization
        },
        {
            label: 'Account Status',
            shortLabel: 'Status',
            icon: 'pi pi-shield',
            route: APOLLO_ROUTES.profile.createSteps.accountStatus
        }
    ];
