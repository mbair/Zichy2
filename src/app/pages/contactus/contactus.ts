...
@Component({
    ...
    template: `
        <div class="grid grid-cols-12 gap-4 card gap-0" style="column-gap: 2rem; row-gap: 2rem;">
            ...
            <div class="col-span-12 mt-8">
                ...
                <div class="grid gap-4 flex-col md:flex-row gap-0 mt-12" style="row-gap: 2rem; column-gap: 2rem;">
