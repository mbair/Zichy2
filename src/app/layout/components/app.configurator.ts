                    ...
                    <div class="pt-2 flex gap-2 flex-wrap">
                        @for (primaryColor of primaryColors(); track primaryColor.name) {
                            <button
                                ...
                                class="config-color-swatch cursor-pointer flex shrink-0 items-center justify-center outline-offset-1 shadow"
                                [style]="{
                    ...
                    <div class="pt-2 flex gap-2 flex-wrap">
                        @for (surface of surfaces; track surface.name) {
                            <button
                                ...
                                class="config-color-swatch cursor-pointer flex shrink-0 items-center justify-center outline-offset-1"
                                [ngClass]="{
...
export class AppConfigurator implements OnInit {
    ...
    toggleConfigSidebar() {
        this.layoutService.layoutState.update((prev) => ({ ...prev, configSidebarVisible: !prev.configSidebarVisible }));
    }
