import{ja as q,ka as g,na as A,pa as P}from"./chunk-BSRWTFBH.js";import{Aa as d,Ba as x,C as v,Ca as M,D as h,Da as w,Db as Q,Fb as E,G as T,Hb as N,Ia as l,Ja as D,Ka as F,M as p,Mb as O,Pa as f,Ra as m,Sa as y,Wa as j,Xa as S,_ as o,cb as z,ga as b,ha as C,ka as $,ma as r,pa as i,sa as k,ta as I,ub as B,za as u}from"./chunk-FODEVAKI.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
